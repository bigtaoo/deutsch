...
笔记还不多的时候，生词本页顶部的**预置词库**可以直接取词先练起来（第 4 档起，约 1.7 万词）。
...
- **预置卡的正面只有声音，没有文字。** 给了文字它就变成「看词回忆意思」，
  而这个 App 存在的理由是听觉识别。声音优先用 Wiktionary 上的真人录音（加词时就下好，
  所以断网也能复习），没有录音的退到系统合成音，卡面会标出是哪一种。
  两者都是**孤立词**发音 —— 练不到连读，那仍然得靠课程里的真语料。
